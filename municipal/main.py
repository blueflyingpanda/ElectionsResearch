...
def convert_parties_to_numbers():
    ...
    text = text.replace('Региональное отделение политической партии "Российская партия пенсионеров за справедливость" в городе Москве', '22')
    text = text.replace('Московское городское региональное отделение Политической партии "ПАРТИЯ ВЕТЕРАНОВ РОССИИ"', '23')
    text = text.replace('Всероссийская политическая партия "Интернациональная партия России"', '24')
    text = text.replace('Региональное отделение Политической партии "Российский Объединённый Трудовой Фронт" в городе Москве', '25')
    text = text.replace('Региональное отделение Политической партии "Общероссийская политическая партия "ДОСТОИНСТВО" в городе Москва', '26')
    text = text.replace('Региональное отделение в г. Москве политической партии "Российский общенародный союз"', '27')
    text = text.replace('РЕГИОНАЛЬНАЯ ОБЩЕСТВЕННАЯ ОРГАНИЗАЦИЯ ПО СОДЕЙСТВИЮ И РАЗВИТИЮ СЕМЬИ И МОЛОДЕЖИ "ВРЕМЯ ПЕРЕМЕН"', '28')
    text = text.replace('Всероссийская политическая партия "Гражданская инициатива"', '29')
    text = text.replace('Общественная организация -  Политическая партия "Партия Возрождения России"', '30')
    text = text.replace('Региональное отделение Всероссийской политической партии "ПАРТИЯ ДЕЛА" в г. Москве', '31')
    text = text.replace('Региональное отделение политической партии "Российская партия пенсионеров за социальную справедливость" в городе Москве', '32')
    file2.write(text)
    file.close()
    file2.close()
