...
административный 1, неадминистративный 2, -1 - непонятно из-за ограничений алгоритма), которая высчитывает по алгоритму
...
def main():
    ...
    for i in df.index:
        if df['smart_vote'][i] == 1:
            ...
            if has_alike_name(df, i) and (df['party'][i] == 4 or df['party'][i] == 8 or df['party'][i] == 9):
    ...
    # print(affiliation_array.count(-1))
